    ...
    <div>
      ...
      >
        <svg
          viewBox="0 0 24 24"
          fill="currentColor"
          className="group/discord h-8 w-8 text-black hover:text-blue-500"
        >
      ...
      {tooltipVisible ? (
        <div
          ...
          className="absolute mt-2 w-56 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 transition-opacity"
        >
